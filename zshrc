...
plugins=(git sudo z fzf autojump command-not-found cp copypath copyfile history-substring-search zsh-autosuggestions)
...
alias config-hardware="sudo nano /etc/nixos/hardware-configuration.nix"
alias rebuild="sudo nixos-rebuild boot"
